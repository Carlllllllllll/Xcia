...
const embeds = [
    ...
    new EmbedBuilder()
        ...
        .setDescription('<a:arrow:1215601724341878815> **Moj Maro With No Limitations**'),
...
module.exports = {
    name: "play",
    description: "Bolo Sir Kya Bajau?",
    permissions: "0x0000000000000800",
    options: [{
        name: "name",
        description: 'Link Bhi De Sakte Ho',
